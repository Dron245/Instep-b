 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".reviews__slider")) new swiper_core_Swiper(".reviews__sliderr", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".sertificates__slider")) new swiper_core_Swiper(".sertificates__slider", {
                modules: [ Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            ...
            inputs.forEach((element => {
                ...
                element.addEventListener("input", (() => {
                    if (element.value == "") element.closest(".popup__form-item").classList.remove("succes"); else element.closest(".popup__form-item").classList.add("succes");
                }));
            }));
